package decode.travel.holidaycheckbackend.model.contract;
...
public class NFT721 extends Contract {
    ...
    protected NFT721(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
